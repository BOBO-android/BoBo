...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    private CheckValidCodeViewModel checkValidCodeViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (email != null && !email.isEmpty()) {
           descriptionEmailTV.setText("Enter the verification code send to your email " + email);
            ...
            descriptionEmailTV.setText("error"); // Giá trị mặc định nếu không có email
        }
        codeInputs = new TextInputEditText[]{code1, code2, code3, code4, code5, code6};

        checkValidCodeViewModel = new ViewModelProvider(this).get(CheckValidCodeViewModel.class);

        checkValidCodeViewModel.getCheckValidCodeResponseMutableLiveData().observe(this, response -> {
            if(response != null){
        ...
        checkValidCodeViewModel.getErrorLiveData().observe(this, error -> {
            showDiaLog(error);
        });
        ...
        continueButton.setOnClickListener(v -> {
            ...
            if (isCode1Filled && isCode2Filled && isCode3Filled && isCode4Filled && isCode5Filled && isCode6Filled) {
                ...
                checkValidCodeViewModel.checkValidCode(email, codeVery);
            }
        });
    }
    ...
    private void startCountdownTimer(long millisInFuture){
        countDownTimer = new CountDownTimer(millisInFuture, 1000) {
            ...
            public void onFinish() {
                ...
                resendTextTV.setTextColor(ContextCompat.getColor(ForgotPasswordActivity.this, R.color.olive_gray));
    ...
    private void enableButtonContinue(){
        ...
        continueButton.setTextColor(ContextCompat.getColor(ForgotPasswordActivity.this, R.color.white));
    };
    private void disableButtonContinue(){
        continueButton.setClickable(false);
        continueButton.setFocusable(false);
        continueButton.setBackgroundResource(R.drawable.custom_button_disable);
        continueButton.setTextColor(ContextCompat.getColor(ForgotPasswordActivity.this, R.color.light_gray));
    }
    // check full code
