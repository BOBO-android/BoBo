...
public class FoodExplorerItemAdapter extends RecyclerView.Adapter<FoodExplorerItemAdapter.FoodExplorerItemViewHolder> {

    private final List<SearchFoodItemModel> foodList;
    private final Context context;
    private OnSearchFoodItemClickListener listener;
    private OnAddToCartClickListener addToCartListener;

    public FoodExplorerItemAdapter(Context context) {
    ...
    public void setOnSearchFoodItemClickListener(OnSearchFoodItemClickListener listener) {
    ...
    @NonNull
    @Override
    public FoodExplorerItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_explorer_food, parent, false);
        return new FoodExplorerItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FoodExplorerItemViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            if (listener != null) {
                listener.onSearchFoodItemClick(food);
            }
        });
    ...
    public static class FoodExplorerItemViewHolder extends RecyclerView.ViewHolder {
        ImageView foodImage;
        TextView foodName;
        TextView foodRating;
        TextView foodPrice;
        ...
        public FoodExplorerItemViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public interface OnSearchFoodItemClickListener {
        void onSearchFoodItemClick(SearchFoodItemModel food);
    }
